...
tempo_que_o_sistema_vai_rodar = 30
...
while tempo_que_o_sistema_vai_rodar > 0:
    ...
    # verifica se a mensagem já foi enviada anteriormente (chama a função send_message dentro dela)
    ...
    time.sleep(5)
    tempo_que_o_sistema_vai_rodar -= 5
